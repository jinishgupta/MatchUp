        ...
        <div className="text-center mb-8">
          {isWin ? (
            <>
              ...
              {isRecordingGame && (
                <motion.div 
                  className="mt-4 bg-blue-900/60 p-3 rounded-lg text-center border border-blue-500"
                  initial={{ y: 10, opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                ...
                >
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <span className="text-blue-200 font-medium">Recording on Blockchain...</span>
                  </div>
                  <p className="text-xs text-blue-300">
                    Please sign the transaction in your wallet to update your stats and leaderboard position
                  </p>
                </motion.div>
              )}
